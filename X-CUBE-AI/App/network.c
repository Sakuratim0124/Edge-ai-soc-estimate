...
#define AI_NETWORK_MODEL_SIGNATURE     "0x628b20f64bea7da8f0bebd091470ad9d"
...
#define AI_TOOLS_DATE_TIME   "2026-06-05T14:09:01+0800"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  5, 0x0,
  AI_SHAPE_INIT(4, 2, 512, 1, 1), AI_STRIDE_INIT(4, 4, 8, 4096, 4096),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  6, 0x0,
  AI_SHAPE_INIT(4, 1, 128, 1, 50), AI_STRIDE_INIT(4, 4, 4, 512, 512),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 271368, 1, 1),
    271368, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 30608, 1, 1),
    30608, NULL, NULL),
  ...
  &_lstm_LSTM_output_0_layer, 0xe7d48062, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    _lstm_LSTM_output_0_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 400);
    _lstm_LSTM_output_0_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 400);
    _lstm_LSTM_output_0_output0_array.data = AI_PTR(g_network_activations_map[0] + 3984);
    _lstm_LSTM_output_0_output0_array.data_start = AI_PTR(g_network_activations_map[0] + 3984);
    _lstm_LSTM_output_0_output1_array.data = AI_PTR(g_network_activations_map[0] + 29584);
    _lstm_LSTM_output_0_output1_array.data_start = AI_PTR(g_network_activations_map[0] + 29584);
    _lstm_LSTM_output_0_output2_array.data = AI_PTR(g_network_activations_map[0] + 30096);
    _lstm_LSTM_output_0_output2_array.data_start = AI_PTR(g_network_activations_map[0] + 30096);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    _lstm_LSTM_output_0_recurrent_array.data = AI_PTR(g_network_weights_map[0] + 4096);
    _lstm_LSTM_output_0_recurrent_array.data_start = AI_PTR(g_network_weights_map[0] + 4096);
    _lstm_LSTM_output_0_bias_array.format |= AI_FMT_FLAG_CONST;
    _lstm_LSTM_output_0_bias_array.data = AI_PTR(g_network_weights_map[0] + 266240);
    _lstm_LSTM_output_0_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 266240);
    _lstm_LSTM_output_0_initial_h_array.format |= AI_FMT_FLAG_CONST;
    _lstm_LSTM_output_0_initial_h_array.data = AI_PTR(g_network_weights_map[0] + 268288);
    _lstm_LSTM_output_0_initial_h_array.data_start = AI_PTR(g_network_weights_map[0] + 268288);
    _lstm_LSTM_output_0_initial_c_array.format |= AI_FMT_FLAG_CONST;
    _lstm_LSTM_output_0_initial_c_array.data = AI_PTR(g_network_weights_map[0] + 268800);
    _lstm_LSTM_output_0_initial_c_array.data_start = AI_PTR(g_network_weights_map[0] + 268800);
    _lstm_LSTM_output_0_peepholes_array.format |= AI_FMT_FLAG_CONST;
    _lstm_LSTM_output_0_peepholes_array.data = AI_PTR(g_network_weights_map[0] + 269312);
    _lstm_LSTM_output_0_peepholes_array.data_start = AI_PTR(g_network_weights_map[0] + 269312);
    _Constant_output_0_array.format |= AI_FMT_FLAG_CONST;
    _Constant_output_0_array.data = AI_PTR(g_network_weights_map[0] + 270848);
    _Constant_output_0_array.data_start = AI_PTR(g_network_weights_map[0] + 270848);
    output_weights_array.format |= AI_FMT_FLAG_CONST;
    output_weights_array.data = AI_PTR(g_network_weights_map[0] + 270852);
    output_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 270852);
    output_bias_array.format |= AI_FMT_FLAG_CONST;
    output_bias_array.data = AI_PTR(g_network_weights_map[0] + 271364);
    output_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 271364);
    return true;
  }
